...
print(xtable(y, caption="Relationship between Project and MPDS between different factor levels"),
             comment = FALSE)
...
xtable(table2, caption = "Amount of Pumps per Site_ID", comment=FALSE)
